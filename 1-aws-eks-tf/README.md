...
1. Check CloudWatch logs (EKS cluster logs)
2. Review Terraform state (`terraform show`)
3. Verify AWS console resources match Terraform outputs
4. Check node logs: `aws ec2 describe-instance-status --instance-ids <node-instance-id>`

---

## 📄 License

This module is provided as-is for educational and internal use.

---

**Last Updated**: March 1, 2026  
**Module Version**: 1.0.0  
**Kubernetes Version Supported**: 1.28 - 1.33  
